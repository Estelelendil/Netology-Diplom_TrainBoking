        ...
        if (index % 2 === 0 && index < 32) {
          return (
            <div className={(item.index + 1) % 4 === 0 ? "flex flex-col ml-[34px] mr-[4px]" : "flex flex-col"}>
              <div className="w-[34px] h-[35px] bg-gray/50 border-1 border-red text-center mr-[0px]">{item.index}</div>
              {seats[index + 1] && (
          ...
          return (
            <div
              className={
                index % 2 === 0
                  ? "w-[51px] h-[30px] bg-gray/50 border-1 border-red text-center mt-[30px]  "
                  : "w-[51px] h-[30px] bg-gray/50 border-1 border-red text-center mt-[30px] mr-[4px] "
              }
            >
              {item.index}
            </div>
